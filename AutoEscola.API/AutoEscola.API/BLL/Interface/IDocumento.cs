...
namespace AutoEscola.API.BLL.Interface
{
    public interface IDocumento : IBaseBLL<DocumentoDTO>
    {
        ...
        Task<DocumentoViewModel> AtualizarStatusDocumento(DocumentoDTO documento);
        Task<DadosAtivacaoContaViewModel> AtivarContaInstrutor(DadosAtivacaoContaDTO dadosAtivacaoConta);
